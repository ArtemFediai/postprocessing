...
def main():
    ...
    for i, folder in enumerate(folders):
        ...
        p_minus = p_minus_reduced + delta_delta_anion  # corrected!!!


        a_p, a_m, b_p, b_m = eps_mod_2(folder, radii, radii_not_renormalized, p_av, [20, 40], [1, 1E5], p_plus, p_minus, 40.0)
        ...
        plt.savefig('CORRECTED_p_plus_minus_{}.png'.format(folder), dpi=600, bbox_inches='tight')
        plt.savefig('CORRECTED_p_plus_minus_{}.svg'.format(folder), bbox_inches='tight')
        plt.savefig('CORRECTED_p_plus_minus_{}.eps'.format(folder), bbox_inches='tight')
