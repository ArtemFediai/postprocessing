...
resc_EA_d=1
rescalex=1.5
PlotDOSAll(IPIP_0_0,EAEA_plus_0_0,IPIP_minus_1_0,EAEA_1_0,Energy,E_fermi,figname,
           ylim_DOS_all,rescalex,resc_IP_h,resc_EA_h,resc_IP_d,resc_EA_d,
           labels=False)

#-----------------------------------
#     Generate Fig. with only IP
#-----------------------------------
ylim_DOS_IP=[-6.2, -5.0]
rescalex_IP=1.1
...
PlotDOSIP(IPIP_0_0,IPIP_minus_1_0,Energy,E_fermi,disorder,dop_frac,IP_h_mean,EA_d_mean,
          figname,rescalex_IP,ylim_DOS_IP,labels=False)
